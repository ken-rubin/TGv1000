		...
		try {
			...
			var functionNewProjectDialog = function () {
				...
				try {
					...
					var m_functionRenderJadeSnippetResponse = function (htmlData) {
						...
						try {
							...
							BootstrapDialog.show({
					            ...
					            buttons: [
					            	{
					            		label: "Create Project Type 0",
					            		cssClass: "btn-primary",
					            		action: function(){

					            			m_functionCreateProject(0);
					            		}
					            	},
					            	{
					            		label: "Create Project Type 1",
					            		cssClass: "btn-primary",
					            		action: function(){

					            			m_functionCreateProject(1);
					            		}
					            	},
					            	{
					            		label: "Create Project Type 2",
					            		cssClass: "btn-primary",
					            		action: function(){

					            			m_functionCreateProject(2);
					            		}
					            	},
					            	{
						                label: "Close",
					...
					var m_functionCreateProject = function (index) {
				...
				// An array of projects for developers to create to test different project configurations.
				var m_projects = 
				[
					// m_projects[0] is
					{
