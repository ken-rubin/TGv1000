...
begin
set @guts := "SET name='WebsiteBaseType',typeTypeId=3,imageId=0,altImagePath=media/images/websiteProject.png,description='null',ownedByUserId=1,public=1,baseTypeId=0";
set @id1 := (select id from types where typeTypeId=3 and name="WebsiteBaseType");
