...
module.exports = function SQL(app) {
    ...
    // On error, it rolls the transaction back and then does callback(error, null);
    ...
    self.executeWithPlaceholders = function (strSql, objValues, functionSuccess, functionError) {
            ...
            m_pool.getConnection(function (err, connection) {
                ...
                try {
                    ...
                    if (err) {
                        ...
                        // Use the connection
                        connection.query(strSql, objValues,
                            function (err, rows) {
