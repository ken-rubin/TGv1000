...
insert TGv1000.methods SET typeId=@id1,name='construct',ordinal=0,statements='[{\"type\":\"CodeStatementExpression\",\"parameters\":[{\"type\":\"CodeExpressionInvocation\",\"parameters\":[\"\",{\"type\":\"ArgumentList\",\"parameters\":[{\"type\":\"Array\"}]}]}]}]',imageId=0,description='[No description provided]',parentMethodId=0,parentPrice=0,priceBump=0,ownedByUserId=1,public=1,quarantined=0,methodTypeId=4,arguments='{\"type\":\"ParameterList\",\"parameters\":[{\"type\":\"Array\",\"parameters\":[]}]}';
