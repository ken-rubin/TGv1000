...
/* TOXXX DONE   var strQuery = "select chargeId, id from " + self.dbname + "projects where ownedByUserId=" + req.body.userId + " and comicProjectId=" + req.body.projectId + ";"; */
                var strQuery = "select chargeId, id from " + self.dbname + "projects where ownedByUserId=" + req.body.userId + " and id in (" + self.dbname + "getProjectsLinkedToComicsOfProject(" + req.body.projectId + "));";
                sql.execute(
                    strQuery,
                    function(rows) {
...
/* TOXXX DONE   var strQuery = "select id from " + self.dbname + "projects where ownedByUserId=" + req.body.userId + " and comicProjectId=" + req.body.projectId + ";";                */
                var strQuery = "select " + self.dbname + "getProjectsLinkedToComicsOfProject(" + req.body.projectId + ") as projectIds;"; // userId check has been moved below.
                sql.execute(
                    strQuery,
                    function(rows) {
...
/* TOXXX DONE           var strQuery = "select count(*) as cnt from " + self.dbname + "projects where comicProjectId=" + passOn.project.id + " and id<>" + passOn.project.id + ";"; */
                        var strQuery = "select " + self.dbname + "getProjectsLinkedToComicsOfProject(" + passOn.project.id + ") as idstring";
...
/* TOXXX DONE           var strQuery = "select u.*, ug.name as usergroupName from " + self.dbname + "user u inner join " + self.dbname + "usergroups ug on u.usergroupId=ug.id where u.id in (select ownedByUserId from " + self.dbname + "projects where id<>comicProjectId and comicProjectId=" + req.body.projectId + ");"; */
                        var strQuery = "select u.*, ug.name as usergroupName from " + self.dbname + "user u inner join " + self.dbname + "usergroups ug on u.usergroupId=ug.id where u.id in (select ownedByUserId from " + self.dbname + "projects where id in (select " + self.dbname + "getProjectsLinkedToComicsOfProject(" + req.body.projectId + ")));";
                        sql.execute(
                            strQuery,
                            function(rows) {
