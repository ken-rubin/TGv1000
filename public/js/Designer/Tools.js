						...
						) 
					{
						try {
							...
							var exceptionRet = m_srToolStripV.addImage(
								...
								"data-type='" + (clType.data.isApp ? "App" : clType.data.ordinal === null ? "Base" : clType.data.name) + "'"	// This becomes the type of the ToolInstance. Done this way in case App type had been renamed 
