...
set @id5 := (select id from types where typeTypeId=2 and name="EventHandler");
...
set @id6 := (select id from types where typeTypeId=2 and name="Math");
...
set @id7 := (select id from types where typeTypeId=2 and name="Number");
...
set @id8 := (select id from types where typeTypeId=2 and name="RegExp");
...
set @id9 := (select id from types where typeTypeId=2 and name="String");
...
set @id10 := (select id from types where typeTypeId=2 and name="VisualObject");
...
insert TGv1000.methods SET typeId=@id2,name='MyMethod',ordinal=1,statements='[]',imageId=0,description='[No description provided]',parentMethodId=0,parentPrice=0,priceBump=0,ownedByUserId=2,public=1,quarantined=0,methodTypeId=4,arguments='{\"type\":\"ParameterList\",\"parameters\":[{\"type\":\"Array\",\"parameters\":[]}]}';
...
insert TGv1000.events SET typeId=@id3,name='MyEvent',ordinal=0;
...
insert TGv1000.methods SET typeId=@id10,name='construct',ordinal=0,statements='[]',imageId=0,description='[No description provided]',parentMethodId=0,parentPrice=0,priceBump=0,ownedByUserId=1,public=1,quarantined=0,methodTypeId=4,arguments='{\"type\":\"ParameterList\",\"parameters\":[{\"type\":\"Array\",\"parameters\":[]}]}';
insert TGv1000.methods SET typeId=@id10,name='update',ordinal=1,statements='[]',imageId=0,description='[No description provided]',parentMethodId=0,parentPrice=0,priceBump=0,ownedByUserId=2,public=1,quarantined=0,methodTypeId=4,arguments='{\"type\":\"ParameterList\",\"parameters\":[{\"type\":\"Array\",\"parameters\":[]}]}';
insert TGv1000.propertys SET typeId=@id10,propertyTypeId=6,name='x',initialValue='Number',ordinal=0,isHidden=0;
insert TGv1000.propertys SET typeId=@id10,propertyTypeId=6,name='y',initialValue='Number',ordinal=1,isHidden=0;
insert TGv1000.propertys SET typeId=@id10,propertyTypeId=6,name='height',initialValue='Number',ordinal=2,isHidden=0;
insert TGv1000.propertys SET typeId=@id10,propertyTypeId=6,name='width',initialValue='Number',ordinal=3,isHidden=0;
insert TGv1000.propertys SET typeId=@id10,propertyTypeId=6,name='color',initialValue='',ordinal=4,isHidden=0;
end;
//
delimiter ;
call doSystemTypes();
