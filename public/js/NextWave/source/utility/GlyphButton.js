...
define(["NextWave/source/utility/prototypes",
    ...
    function(prototypes, settings, glyphs, Point, Size, Area, Control) {
        ...
        try {
            ...
            var functionRet = function GlyphButton(glyph) {
...
*/
                                // Again, if self.protected, nothing special for the glyph.
                                if (self.protected) {
...
*/
									contextRender.drawImage(self.glyph,
											m_area.location.x, 
											m_area.location.y,
											m_area.extent.width,
